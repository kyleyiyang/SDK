...
if constructed_okay == -1:
    ...
    for i in range(0, 10):
        slm_lib.Write_overdrive_image(board_number, ImageOne.ctypes.data_as(POINTER(c_ubyte)), wait_For_Trigger, output_Pulse, timeout_ms)
        sleep(1.0) # This is in seconds
        slm_lib.Write_overdrive_image(board_number, ImageTwo.ctypes.data_as(POINTER(c_ubyte)), wait_For_Trigger, output_Pulse, timeout_ms)
        sleep(1.0) # This is in seconds
