...
extern "C" { /* using a C++ compiler */
	...
	IMAGE_GEN_API void Generate_FresnelLens(unsigned char* Array, int width, int height, int centerX, int centerY, int radius, double Power, int cylindrical, int horizontal);

	IMAGE_GEN_API void Generate_Grating(unsigned char* Array, int width, int height, int Period, int increasing, int horizontal);

	IMAGE_GEN_API void Generate_Sinusoid(unsigned char* Array, int width, int height, int Period, int horizontal);

	IMAGE_GEN_API void Generate_LG(unsigned char* Array, int width, int height, int VortexCharge, int centerX, int centerY, int fork);
	...
	IMAGE_GEN_API void Generate_Axicon(unsigned char* Array, int width, int height, int PhaseDelay, int centerX, int centerY, int increasing);
	...
	IMAGE_GEN_API int Generate_Hologram(unsigned char *Array, float *x_spots, float *y_spots, float *z_spots, float *I_spots, int N_spots);
