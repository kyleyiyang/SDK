...
int main()
{
  ...
  if (constructed_okay == 0)
  {
    ...
    int height = Get_image_height(board_number);
	  ...
	  for (int i = 0; i < 5; i++)
	  {
		  Write_overdrive_image(board_number, ImageOne, ExternalTrigger, OutputPulse, 5000);
		  Sleep(500);

		  Write_overdrive_image(board_number, ImageTwo, ExternalTrigger, OutputPulse, 5000);
		  Sleep(500);
	  }
